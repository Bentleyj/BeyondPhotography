...
//    effects.push_back(oilPaintColor);
    ...
    sobelStretchCenter.width = ofGetWidth();
    sobelStretchCenter.height = ofGetHeight();
    ...
    sobelStretchY.width = ofGetWidth();
    ...
    sobelPixBlocks.width = ofGetWidth();
    ...
    drawingArcGrid.width = ofGetWidth();
